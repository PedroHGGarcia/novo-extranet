...
import { getRegioes, createRegiao, deleteRegiao } from '@/services/cadastros'
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-[#3b82f6] font-semibold">UF</TableHead>
          ...
          <TableBody>
            {filtered.map((item) => (
              <TableRow key={item.id} className="hover:bg-slate-50 border-b-gray-100">
                ...
                <TableCell className="text-gray-600">{item.uf}</TableCell>
                <TableCell>
