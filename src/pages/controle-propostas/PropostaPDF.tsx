...
export default function PropostaPDF() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 print:bg-white flex justify-center py-8 print:py-0">
      ...
      <div className="bg-white text-slate-800 font-sans text-[13px] leading-relaxed w-[210mm] max-w-full min-h-[297mm] p-12 shadow-lg print:shadow-none print:w-full print:m-0 relative">
        {/* Header */}
        ...
        <div className="mb-8 print-break-inside-avoid">
          ...
          <div className="bg-slate-50 border border-slate-200 p-5 rounded-sm">
            ...
            {Array.isArray(proposta.acessorios_proposta) &&
              proposta.acessorios_proposta.length > 0 && (
                <div className="mt-4">
